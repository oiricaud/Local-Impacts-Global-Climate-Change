...
CREATE TABLE IF NOT EXISTS `survey_001_models_from_tables`.`survey_headers` (
  ...
  INDEX `fk_surveys_organizations1_idx` (`organization_id` ASC),
...
CREATE TABLE IF NOT EXISTS `survey_001_models_from_tables`.`survey_sections` (
  ...
  INDEX `fk_survey_sections_surveys1_idx` (`survey_header_id` ASC),
...
CREATE TABLE IF NOT EXISTS `survey_001_models_from_tables`.`questions` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_questions_question_types1_idx` (`input_type_id` ASC),
  INDEX `fk_questions_survey_sections1_idx` (`survey_section_id` ASC),
  INDEX `fk_questions_option_type_group1_idx` (`option_group_id` ASC),
...
CREATE TABLE IF NOT EXISTS `survey_001_models_from_tables`.`option_choices` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_option_type_choices_option_type_group1_idx` (`option_group_id` ASC),
...
CREATE TABLE IF NOT EXISTS `survey_001_models_from_tables`.`question_options` (
  ...
  INDEX `fk_question_options_option_choices1_idx` (`option_choice_id` ASC),
...
CREATE TABLE IF NOT EXISTS `survey_001_models_from_tables`.`answers` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_answers_surveyees1_idx` (`user_id` ASC),
  INDEX `fk_answers_unit_of_measure1_idx` (`unit_of_measure_id` ASC),
  INDEX `fk_answers_question_options1_idx` (`question_option_id` ASC),
...
CREATE TABLE IF NOT EXISTS `survey_001_models_from_tables`.`survey_comments` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_survey_comments_users1_idx` (`user_id` ASC),
  INDEX `fk_survey_comments_surveys1_idx` (`survey_header_id` ASC),
...
CREATE TABLE IF NOT EXISTS `survey_001_models_from_tables`.`user_survey_sections` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_user_survey_sections_survey_sections1_idx` (`survey_section_id` ASC),
  INDEX `fk_user_survey_sections_users1_idx` (`user_id` ASC),
